...
plt.savefig(snapshot+'_powerspec_RSD_all.png')
#### Writing ######                                                                                             

f_out=snapshot+'_powerspec_RSD_all.dat'
...
#        plt.savefig(snapshot+'_powerspec.png')
        #### Writing ######                                           
        f_out=snapshot+'_powerspec_RSD_type'+str(type)+'.dat'
